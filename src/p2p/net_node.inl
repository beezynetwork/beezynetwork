...
namespace nodetool
{
  ...
  const static boost::uuids::uuid P2P_NETWORK_ID = { { 0x12, 0x12, 0x01, 0x13, 0x01, 0x11, 0x10, 0x31, 0x18, 0x11, P2P_NETWORK_ID_TESTNET_FLAG, 0x15, 0x41, 0x61, 0x11, P2P_NETWORK_ID_VER} };
  ...
  bool node_server<t_payload_net_handler>::init(const boost::program_options::variables_map& vm)
  {
    ...
    ADD_HARDCODED_SEED_NODE("5.45.109.73", P2P_DEFAULT_PORT);
